...
import backIcon from '../../assets/icons/res/drawable-hdpi/outline_arrow_back_black_18.png';
...
export const CrudProdutos = () => {
    ...
    return(
        <View>
            <View>
                <Image source={require('../../assets/icons/res/drawable-hdpi/outline_arrow_back_black_18.png')} />
                <Text>Login</Text>
            </View>
            <View>
            ...
            <FlatList data={produtos} renderItem={ ({ item }) =>
                <ScrollView>
                    ...
                    <View>
                        <Image style={{width:50, height:50}} source={{uri:item.fotoLink}} />
                        <View>
